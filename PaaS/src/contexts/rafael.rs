...
pub mod env{ 
    ...
    #[derive(Serialize, Deserialize)] // TODO - add wasm_bindgen proc macro attribute to compile this to wasm
    ...
    impl<S> Runtime<S>{ // TODO - add wasm_bindgproc macro attribute en and rayon (split data using divide and conquer simd based design pattern and std::thread pool and mpsc) to compile this to wasm to call the wasm compiled methods using ayoub cli and inside js
