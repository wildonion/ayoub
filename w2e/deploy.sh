...
NEAR_ENV=$NETWORK near deploy --wasmFile out/w2e.wasm --accountId $OWNER_ID
...
then
    ...
    NEAR_ENV=$NETWORK near deploy --wasmFile out/w2e.wasm --accountId $SUB_MASTER_CONTRACT_ID.$OWNER_ID
fi