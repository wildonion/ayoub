...
# ./ayoub.sh deploy --service <SERVICE_NAME> --port-number <PORT> -> deploy the selected service on cloud using docker (needs docker compose or dockerfile and behalf of the fandogh PaaS)
