...
read RECEIVER_ID # NOTE - it can be the contract id to mint all nfts on like a market contract or another account id 
...
then
    ...
    echo "[?] Receiver Account ID - Mint NFT On? >>>"
    read RECEIVER_ID # NOTE - it can be either the sub contract id to mint all nfts on like a market contract or another account id
