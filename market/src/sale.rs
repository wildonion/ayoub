...
pub struct Sale{
    pub owner_id: AccountId, //-- the owner_id or the seller of the NFT that wants to sale 
    pub approval_id: u64, //-- market contract actor approval_id to transfer the NFT on behalf of the owner 
    pub nft_contract_id: String, //-- the account_id that the NFT was minted on which might be the account of the owner or the seller
    pub token_id: TokenId, //-- the NFT token_id
