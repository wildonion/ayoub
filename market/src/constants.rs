...
pub static DELIMETER: &str = "."; //-- every sale will have a unique id which is in form `nft_contract_actor_account_id + DELIMETER + token_id` - contract actor account_id is the account_id that the NFT contract is deployed on 
